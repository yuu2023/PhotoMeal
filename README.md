...
## ユーザー利用環境
   ...
   - 本サービスの全ての機能を利用するにはブラウザの設定で位置情報の取得を許可をしていただく必要があります。位置情報を取得されたくないユーザーにも、検索機能を代替機能として利用いただけます。

   - 本サービスの全ての機能を利用するには位置情報を持つ写真が必要になります。位置情報を取得されたくないユーザーにも、検索機能を代替機能として利用いただけます。
