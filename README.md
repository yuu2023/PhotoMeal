...
## ユーザー利用環境
   ...
   - 本サービスの全ての機能をご利用になるには位置情報を持つ写真が必要になります。位置情報を取得されたくないユーザーにも、検索機能を代替機能として利用いただけます。

   - 本サービスの全ての機能をご利用になるにはブラウザの設定で位置情報の取得を許可をしていただく必要があります。位置情報を取得されたくないユーザーにも、検索機能を代替機能として利用いただけます。

   - PCでご利用の際、インターネットのIPアドレスを元に現在地を割り出すため、現在地の取得の制度が下がる可能性があります。
