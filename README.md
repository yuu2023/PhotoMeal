...
- **料理**
    ...
    - シングル画面
      ...
      <kbd><img width="200" alt="料理シングル画面1" src="https://github.com/yuu2023/PhotoMeal/assets/131323286/df184f54-c314-4720-9e9f-7b0b915f6ee9"></kbd>
      <kbd><img width="200" alt="料理シングル画面2" src="https://github.com/yuu2023/PhotoMeal/assets/131323286/a49f2c57-cf76-4e62-84d1-b503645ad5fa"></kbd>
      - 表示
        - 料理の情報を確認できます。
        - 店舗の情報を確認できます。
        - 料理の公開範囲外のユーザーには表示されないようにしています。
...
　バックエンド　： PHP(8.2.5) , Laravel(10.9.0) , MySQL, グルメサーチAPI, Yahoo!ジオコーダAPI, Yahoo!リバースジオコーダAPI

　フロントエンド： HTML・CSS(SCSS), JavaScript, Bootstrap5, Tailwind CSS(3.3.2), Leaflet
 
## ユーザー利用環境

   - 本サービスはスマホユーザが多いことを想定し作成しています。
     - レスポンシブデザインとなっていますので、PCやタブレットにも対応しています。
   - 本サービスの全ての機能を利用するにはブラウザの設定で位置情報の取得を許可をしていただく必要があります。
     - 位置情報を取得されたくないユーザーにも、検索機能を代替機能として利用いただけます。
   - 本サービスの全ての機能を利用するには位置情報を持つ写真が必要になります。
     - 位置情報を取得されたくないユーザーにも、検索機能を代替機能として利用いただけます。
